...
def paradigm2_check(T):
    return (bool(T[0][1]*T[0][2]*T[0][3]) and (T[2][1] + T[2][2] > T[2][3]) 
        and (T[2][1] + T[2][3] > T[2][2]) and (T[2][2] + T[2][3] > T[2][1]))
...
def paradigm5_check(T):
    if bool(T[0][1]*T[0][5]*T[0][6]):
        if (T[2][1]>0 and (0<T[2][5]<180) and (0<T[2][6]<180)
            and (T[2][5]+T[2][6]<180)):
            T[3][2] = 0
            return True
    if bool(T[0][2]*T[0][4]*T[0][6]):
        if (T[2][2]>0 and (0<T[2][4]<180) and (0<T[2][6]<180)
            and (T[2][4]+T[2][6]<180)):
            T[3][2] = 1
            return True
    if bool(T[0][3]*T[0][4]*T[0][5]):
        if (T[2][3]>0 and (0<T[2][4]<180) and (0<T[2][5]<180)
            and (T[2][4]+T[2][5]<180)):
            T[3][2] = 2
            return True
    return False

def paradigm6_check(T):
    return (bool(T[0][0]*T[0][5]*T[0][6]) and (T[2][0]>0) and (0<T[2][5]<180) and (0<T[2][6]<180)
        and (T[2][5]+T[2][6]<180))

def paradigm7_check(T):
    if (bool(T[0][0]*T[0][4]*T[0][5])):
        if (T[2][0]>0) and (0<T[2][4]<180) and (0<T[2][5]<180) and (T[2][4]+T[2][5]<180):
            T[3][2] = 1
            return True
    if (bool(T[0][0]*T[0][4]*T[0][6])):
        if (T[2][0]>0) and (0<T[2][4]<180) and (0<T[2][6]<180) and (T[2][4]+T[2][6]<180):
            T[3][2] = 2
            return True
...
def inspect(T):
    ...
    if (not defined) and (bool(T[0][0]*T[0][1])):
        ...
        T[3][0] = True
        defined = True
    elif (not defined) and (paradigm6_check(T)):
        T[3][1] = 6
        T[3][0] = True
        defined = True
    elif (not defined) and (paradigm7_check(T)):
        T[3][1] = 7
        T[3][0] = True
        defined = True
    else:
